...
import { PortableStorageConstants } from '../Types';
/** @ignore */
...
export class PortableStorage {
    constructor() {
        this.m_version = PortableStorageConstants.VERSION;
        this.m_signatureA = PortableStorageConstants.SIGNATURE_A;
        this.m_signatureB = PortableStorageConstants.SIGNATURE_B;
        this.m_entries = [];
    }
    get version() {
