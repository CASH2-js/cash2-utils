...
export declare class Multisig {
     ...
     */
    private get calculated_multisig_keys();
    /**
     ...
     * @returns a new instance of the object
     */
    static fromMultisigKeys(multisig_private_keys: string[], sharedPrivateViewKey: string, threshold: number, participants: number): Multisig;
    /**
