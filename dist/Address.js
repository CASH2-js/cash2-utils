...
export class Address {
    constructor() {
        this.m_keys = new ED25519.Keys();
        this.m_language = 'english';
        this.m_subwalletIndex = 0;
        this.m_prefix = new AddressPrefix(Config.addressPrefix);
    ...
    static fromAddress(address, prefix) {
        ...
        const checksum = (new Reader(TurtleCoinCrypto.cn_fast_hash(decodedPrefix + paymentId + publicSpend + publicView))).bytes(SIZES.CHECKSUM).toString('hex');
        if (expectedChecksum !== checksum) {
            throw new Error('Could not parse address: checksum mismatch');
        }
        const result = new Address();
        result.m_paymentId = paymentId;
        result.m_keys = new ED25519.Keys(new ED25519.KeyPair(publicSpend), new ED25519.KeyPair(publicView));
        return result;
    }
    /**
    ...
    static fromPublicKeys(publicSpendKey, publicViewKey, paymentId, prefix) {
        ...
        address.m_keys = new ED25519.Keys(new ED25519.KeyPair(publicSpendKey), new ED25519.KeyPair(publicViewKey));
        return address;
    }
    /**
    ...
    static fromViewOnlyKeys(publicSpendKey, privateViewKey, paymentId, prefix) {
        ...
        address.m_keys = new ED25519.Keys(new ED25519.KeyPair(publicSpendKey), new ED25519.KeyPair(undefined, privateViewKey));
        return address;
    }
    /**
    ...
    static fromKeys(privateSpendKey, privateViewKey, prefix) {
        ...
        address.m_keys = new ED25519.Keys(new ED25519.KeyPair(undefined, privateSpendKey), new ED25519.KeyPair(undefined, privateViewKey));
    ...
    static fromSeed(seed, language, prefix) {
        ...
        address.m_keys = new ED25519.Keys(new ED25519.KeyPair(undefined, seed), new ED25519.KeyPair(undefined, seed, undefined, 1));
        return address;
    }
    /**
