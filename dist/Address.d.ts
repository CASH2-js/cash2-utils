...
export declare class Address {
     ...
     */
    static fromAddress(address: string, prefix?: AddressPrefix | number): Address;
    /**
     ...
     * @returns a new address object
     */
    static fromPublicKeys(publicSpendKey: string, publicViewKey: string, paymentId?: string, prefix?: AddressPrefix | number): Address;
    /**
     ...
     * @returns a new address object
     */
    static fromViewOnlyKeys(publicSpendKey: string, privateViewKey: string, paymentId?: string, prefix?: AddressPrefix | number): Address;
    /**
     ...
     * @returns a new address object
     */
    static fromKeys(privateSpendKey: string, privateViewKey: string, prefix?: AddressPrefix | number): Address;
    /**
     ...
     * @returns a new address object
     */
    static fromMnemonic(mnemonic: string, language?: string, prefix?: AddressPrefix | number): Address;
    /**
     ...
     * @returns a new address object
     */
    static fromSeed(seed: string, language?: string, prefix?: AddressPrefix | number): Address;
    /**
     ...
     * @returns a new address object
     */
    static fromEntropy(entropy?: string, language?: string, prefix?: AddressPrefix | number): Address;
    /**
     ...
     */
    static generateSeed(entropy?: string, iterations?: number): string;
    /**
     ...
     * @returns a new address object
     */
    static generateSubwallet(privateSpendKey: string, subwalletIndex: number, language?: string, prefix?: AddressPrefix | number): Address;
    /**
