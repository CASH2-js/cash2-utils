...
export class MultisigMessage {
    ...
    constructor(source, destination, nonce) {
        this.m_source = new Address();
        this.m_spendKeys = [];
        this.m_privateViewKey = new ED25519.KeyPair();
        this.m_nonce = 1;
        this.m_partialKeyImages = [];
        this.m_partialSigningKeys = [];
        this.m_preparedTransactions = [];
        this.m_destination = new Address();
        if (source) {
            this.source = source;
        }
        if (destination) {
    ...
    static decode(destination, base58) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield TurtleCoinCrypto.cn_fast_hash(rawData);
            ...
            if (!(yield TurtleCoinCrypto.checkSignature(hash, source.spend.publicKey, signature))) {
    ...
    encode() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield TurtleCoinCrypto.cn_fast_hash(writer.blob);
            const sig = yield TurtleCoinCrypto.generateSignature(hash, this.source.spend.publicKey, this.source.spend.privateKey);
            writer.hex(sig);
...
function encrypt(source, destination, payload, nonce) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const aesKey = Buffer.from(yield TurtleCoinCrypto.generateKeyDerivation(destination.spend.publicKey, source.spend.privateKey), 'hex');
...
function decrypt(destination, transfer, nonce) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const aesKey = Buffer.from(yield TurtleCoinCrypto.generateKeyDerivation(sender.spend.publicKey, destination.spend.privateKey), 'hex');
        const ctx = new ModeOfOperation.ctr(aesKey, new Counter(nonce));
...
function verifySpendKeySignatures(spendKeys) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const spendKey of spendKeys) {
            if (!(yield TurtleCoinCrypto.checkSignature(spendKey.key, spendKey.key, spendKey.signature))) {
