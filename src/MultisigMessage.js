...
class MultisigMessage {
    ...
    static decode(destination, base58) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const source = Address_1.Address.fromAddress(transfer.address);
            ...
            for (const publicSpendKey of payload.publicSpendKeys) {
                result.m_spendKeys.push(new Types_1.ED25519.KeyPair(publicSpendKey.key));
            }
            ...
            result.m_privateViewKey = new Types_1.ED25519.KeyPair(undefined, payload.privateViewKey);
...
function decrypt(destination, transfer, nonce) {
    return __awaiter(this, void 0, void 0, function* () {
        const sender = Address_1.Address.fromAddress(transfer.address);
...
function calculateSpendKeySignatures(spendKeys) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const keys of spendKeys) {
            ...
            const sig = Types_1.TurtleCoinCrypto.generateSignature(keys.publicKey, keys.publicKey, keys.privateKey);
