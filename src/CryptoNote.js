...
class CryptoNote {
    ...
    generateKeyImagePrimitive(publicSpendKey, privateSpendKey, outputIndex, derivation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Types_1.TurtleCoinCrypto.generateKeyImage(publicEphemeral, privateEphemeral);
        });
    }
    /**
    ...
    createIntegratedAddress(address, paymentId, prefix) {
        ...
        const addr = Address_1.Address.fromAddress(address);
    ...
    generateTransactionOutputs(address, amount) {
        ...
        const result = [];
        const destination = Address_1.Address.fromAddress(address);
    ...
    createTransactionStructure(outputs, inputs, randomOutputs, mixin, feeAmount, paymentId, unlockTime, extraData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const neededMoney = Types_1.BigInteger.zero;
            ...
            const foundMoney = Types_1.BigInteger.zero;
...
function prepareRingSignatures(hash, keyImage, publicKeys, realOutputIndex, derivation, outputIndex, index) {
    return __awaiter(this, void 0, void 0, function* () {
        const prepped = yield Types_1.TurtleCoinCrypto.prepareRingSignatures(hash, keyImage, publicKeys, realOutputIndex);
        return {
            index: index,
...
function prepareTransactionOutputs(outputs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const transactionKeys = new Types_1.ED25519.KeyPair(keys.publicKey, keys.privateKey);
